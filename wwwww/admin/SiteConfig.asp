    ...
    <td bgcolor="#FFFFFF"><br>
     <form method="POST" action="SiteConfig.asp" id="form" name="form">
      <table width="96%"  border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
		...
		<tr> 
		  <td align="right" bgcolor="#FFFFFF">网站开关：</td>
		  <td bgcolor="#FFFFFF"><input name="ks" type="radio" value="1"<%if ""&ks&""=1 then Response.Write("checked") end if%>>开
		  <input name="ks" type="radio" value="0"<%if ""&ks&""=0 then Response.Write("checked") end if%>> 关</td>
		</tr>
        <tr> 
          <td align="right" bgcolor="#FFFFFF">报修描述：</td>
...
sub SaveConfig()
	...
	hf.write "Const ks=" & chr(34) & trim(request("ks")) & chr(34) & "                         '开关" & vbcrlf
	hf.write "Const description=" & chr(34) & InPutStr(trim(request("description"))) & chr(34) & "  '描述" & vbcrlf
	hf.write "Const Copyright=" & chr(34) & InPutStr(trim(request("Copyright"))) & chr(34) & "  '版权" & vbcrlf
	hf.write "%" & ">"
	hf.close
	set hf=nothing
	set fso=nothing	
